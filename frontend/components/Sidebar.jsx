  ...
  return (
    <div className="w-64 h-screen bg-[#171717] border-r border-gray-800 flex flex-col">
      ...
      <div className="p-4 border-b border-gray-800">
        <h1 className="text-lg font-semibold">🛡 Insurance AI</h1>
      ...
      <div className="flex-1 overflow-y-auto p-4 space-y-3">
        <p className="text-gray-400 text-sm">Recent Claims</p>

        <div className="space-y-2">
          <div className="p-2 rounded bg-[#2a2a2a] hover:bg-[#333] cursor-pointer text-sm">
            🚗 Car Damage Claim
          </div>
